...
Shader "Hair"
{
	Properties
	{
		_Cutoff( "Mask Clip Value", Float ) = 0.34
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 temp_output_1_0_g24 = normalizeResult6_g16;
			...
			float3 normalizeResult11_g24 = normalize( ( LightDirection47 + ViewVector49 ) );
			float dotResult13_g24 = dot( temp_output_1_0_g24 , normalizeResult11_g24 );
			float smoothstepResult7_g24 = smoothstep( -1.0 , 0.0 , dotResult13_g24);
			float dotResult18_g24 = dot( temp_output_1_0_g24 , normalizeResult11_g24 );
			float temp_output_150_0 = ( smoothstepResult7_g24 * ( pow( sqrt( ( 1.0 - ( dotResult18_g24 * dotResult18_g24 ) ) ) , _Highlight_1_Power ) * _Highlight_1_Strength ) );
			...
			float3 normalizeResult6_g25 = normalize( ( normalizeResult17 + ( ( _Highlight_2_Shift + temp_output_35_0 ) * normalizeResult13 ) ) );
			float3 temp_output_1_0_g26 = normalizeResult6_g25;
			float3 normalizeResult11_g26 = normalize( ( LightDirection47 + ViewVector49 ) );
			float dotResult13_g26 = dot( temp_output_1_0_g26 , normalizeResult11_g26 );
			float smoothstepResult7_g26 = smoothstep( -1.0 , 0.0 , dotResult13_g26);
			float dotResult18_g26 = dot( temp_output_1_0_g26 , normalizeResult11_g26 );
			float temp_output_151_0 = ( smoothstepResult7_g26 * ( pow( sqrt( ( 1.0 - ( dotResult18_g26 * dotResult18_g26 ) ) ) , _Highlight_2_Power ) * _Highlight_2_Strength ) );
...
/*ASEBEGIN
Version=18800
72;313;1571;700;-2100.443;-649.5693;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-2147.93,1765.504;Inherit;False;Property;_JitterStrength;JitterStrength;16;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1681.83,1220.94;Inherit;False;Property;_GeneralShift;GeneralShift;7;0;Create;True;0;0;0;False;0;False;0.8;0.19;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;970.377,896.0994;Inherit;False;Property;_Desaturate_TextureColor;Desaturate_TextureColor;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;44;-737.043,210.469;Inherit;False;291;209;Shift Tangent 1;1;43;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;66;-355.765,59.38558;Inherit;False;996.1727;488.5634;Primary Highlight;5;50;48;51;52;150;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;68;823.1448,668.0603;Inherit;True;Property;_TextureSample0;Texture Sample 0;13;0;Create;True;0;0;0;False;0;False;-1;ff68836c59202944380e84509e80d8e5;dfcf2d183e984b14388fd8f5ea9739e6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;67;-339.1427,567.5775;Inherit;False;1037.55;478.3715;Secondary Highlight;5;56;54;55;57;151;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;148;1260.379,1138.808;Inherit;False;Property;_Texture_Strength;Texture_Strength;19;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;42;-682.8954,580.0141;Inherit;False;ASEF_ShiftTangent;-1;;25;39d09a43ecc973744b8339a00c34f086;0;3;3;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-240.97,788.141;Inherit;False;Property;_Highlight_2_Power;Highlight_2_Power;8;0;Create;True;0;0;0;False;0;False;1000;20.21;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;150;93.46875,110.5522;Inherit;False;ASEF_StrandSpec;-1;;24;bbb8858f7ec589241a0890523416146f;0;5;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;77;1366.044,1272.005;Inherit;False;Property;_Hair_Color;Hair_Color;14;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;55;-278.97,704.141;Inherit;False;49;ViewVector;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;151;110.0911,618.7441;Inherit;False;ASEF_StrandSpec;-1;;26;bbb8858f7ec589241a0890523416146f;0;5;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;139;2784.326,846.8619;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
WireConnection;137;9;68;4
WireConnection;137;10;68;4
WireConnection;137;13;145;0
ASEEND*/
//CHKSM=3B9F8A1AD55AA07C83B9BD6BE25E26EA4E110B94